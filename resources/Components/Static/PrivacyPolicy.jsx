...
class PrivacyPolicy extends Component {
  render() {
    return(
      <section>
          <div className="text-center privacy-policy-copy">
            <h1>Privacy Policy</h1>
            <p>This privacy policy discloses the privacy practices for Foodle.com, commonSenseDietApp. This privacy policy applies solely to information collected by this web site and certain third parties mentioned here after. It will notify you of the following:</p>
            <ol>
            ...
            <h2>COOKIES AND THIRD-PARTY VENDORS</h2>
